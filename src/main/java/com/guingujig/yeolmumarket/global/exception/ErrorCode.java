...
public enum ErrorCode {
  ...
  REDIS_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "일시적인 서버 오류입니다. 잠시 후 다시 시도해 주세요."),
  ...
  REFUND_REQUEST_ALREADY_EXISTS(HttpStatus.CONFLICT, "해당 주문의 환불 요청이 이미 존재합니다."),
  INVALID_REFUND_REQUEST_STATUS(HttpStatus.CONFLICT, "현재 환불 요청 상태에서 수행할 수 없는 작업입니다."),
